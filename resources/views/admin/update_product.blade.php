        ...
        <div class="main-panel">
          ...
          @endif
            ...
            <form action="{{url('/update_product_confirm',$product->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <input class="text_color" type="text" name="title" placeholder="Enter Product Title" required="" value="{{$product->title}}">
                </div>
                ...
                <input class="text_color" type="number" name="dis_price" placeholder="Enter Product Discount Price" value="{{$product->discount_price}}">
                </div>
                ...
                <img style="margin:auto;" src="/product/{{$product->image}}" height="100" width="70">
                </div>
